...
const EMPLOYEE_PAGES = [
  ...
  { label: "Document Automation", path: "documents" },
  { label: "Create New Document", path: "documents/create" },
  { label: "Document History", path: "documents/history" },
  { label: "Signature Requests", path: "documents/pending" },
