...
DROP POLICY IF EXISTS "documents_select_org_members" ON storage.objects;
...
DROP POLICY IF EXISTS "documents_delete_admins" ON storage.objects;
...
-- SELECT: org members can read their own org's files
DROP POLICY IF EXISTS "contract_scans_select_org_members" ON storage.objects;
...
-- DELETE: owner/admin can delete
DROP POLICY IF EXISTS "contract_scans_delete_admins" ON storage.objects;
